...
### !!! This project is not endorsed or supported by Lime or any affiliated companies. Only do this on legally obtained scooters you own. Premade IoTs can only be optained from us with a proof of ownership !!!
![Screenshot from 2024-10-26 20-11-15](https://github.com/user-attachments/assets/0cac2b74-272c-4492-96e0-abf0aa59c0ce)
...
- **DC-DC stepdown converter** for converting the battery voltage to 5v.
- **ESP32 C3** wich handles display and esc communication, ble and remote commands.
- **433Mhz Receiver (optional)** for receiving 433Mhz commands from the remote.
- **IMU (optional)** for detecting illegal movement.
